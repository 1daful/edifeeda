...
export class Zeptomail {
    ...
    sendMail(user: Record<string, any>, email: Record<string, any>, cc: Record<string, any>, bcc: Record<string, any>) {
        this.client.sendMail({ 
            ...
            to: [ { 
                ...
                cc: cc, 
                bcc: bcc, 
                track_clicks: true, track_opens: true, "client_reference": "<client reference>", 
                //mime_headers: { X-Zylker-User: "test-xxxx" }, 
                attachments: [ { content: "..x+SEXa3zKfnDnBA2qExtXikBpUAFABQAhGSPY/0IoAWgD/2Q==", 
                mime_type: "image/jpg", name: "DM-welcome-guide" 
            }, 
            { file_cache_key: "<File Cache Key>", name: "DM-reports" } ], 
            inline_images: [ { 
                mime_type: "image/jpg", 
    ...
    sendMailWithTemplate(user: Record<string, any>, cc: Record<string, any>, bcc: Record<string, any>) {
